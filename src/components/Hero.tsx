  ...
  return (
    <section className='text-gray-700 flex flex-col place-items-start gap-6 max-w-xl pt-24 pb-44'>
      ...
      <div className='flex gap-4 text-md' >
        <a href="mailto:dmedinasm@gmail.com" target='_blank' className='px-4 py-2 rounded-full border border-gray-300 hover:text-white hover:bg-gray-900'><p className='flex items-center gap-2'><TbMailForward/>Contáctame</p></a>
